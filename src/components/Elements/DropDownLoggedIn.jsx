...
export const DropDownLoggedIn = ({ showUser }) => {
  return (
    <div id="dropdownAvatar" className={`select-none	absolute top-16  right-40 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow ${showUser ? "" : "hidden"} dark:bg-gray-700 dark:divide-gray-600`}>
